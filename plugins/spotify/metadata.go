...
//
// Spotify provides track/album/artist info + search via the Web API, and REAL
// audio (decrypted Ogg Vorbis) via the embedded librespot path. AllowGroupURL
// stays true so shared Spotify links resolve in groups like any other platform
// link.
